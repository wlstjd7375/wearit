...
@SuppressLint("WrongCall") public abstract class ExtendableListView extends AbsListView {
    ...
    // TODOX : ItemClick support from AdapterView
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        // TODOX : handle focus and its impact on selection - if we add item selection support
    }
    ...
    protected void onLayout(final boolean changed, final int l, final int t, final int r, final int b) {
        ...
        // TODOX get the height of the view??
        mInLayout = true;
        layoutChildren();
        mInLayout = false;
    }
    ...
    protected void handleDataChanged() {
        ...
        // TODOX : add selection handling here
    }
...
//                }
    ...
    private boolean onTouchDown(final MotionEvent event) {
        ...
        // TODOX : use the motion position for fling support
        // TODOX : support long press!
        // startLongPressCheck();
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private void onSecondaryPointerUp(MotionEvent event) {
        ...
        if (pointerId == mActivePointerId) {
            ...
            // TODOX: Make this decision more intelligent.
    ...
    private boolean moveTheChildren(int deltaY, int incrementalDeltaY) {
        ...
        // TODOX : touch mode selector handling
        mBlockLayoutRequests = false;
        invokeOnItemScrollListener();
    ...
    private void setupChild(View child, int position, int y, boolean flowDown,
        ...
        final boolean isSelected = false; // TODOX : selected && shouldShowSelector();
    ...
    public Parcelable onSaveInstanceState() {
        ...
        // TODOX : sync selection when we handle it
